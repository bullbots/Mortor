...
//            configSupplyCurrentLimit(SupplyCurrentLimitConfiguration(true, 20.0, 15.0,0.5))
            ...
            configStatorCurrentLimit(StatorCurrentLimitConfiguration(true, 100.0, 75.0, 1.0))
            configSupplyCurrentLimit(SupplyCurrentLimitConfiguration(true, 80.0, 60.0,0.5))
        }
